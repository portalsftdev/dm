...
{block 'content'}
        ...
        {$_modx->RunSnippet('!mFilter2', [
            ...
            'paginator' => 'pdoPage@pageNavVar=`page.nav`',
            'canonicalQueryString' => true,
            'tplFilter.outer.color' => '@FILE chunks/tpl.filter.outer.msoption.msColor.tpl',
            'tplFilter.row.color' => '@FILE chunks/tpl.filter.row.msoption.msColor.tpl',
            'tplFilter.outer.shield-color' => '@FILE chunks/tpl.filter.outer.msoption.msColor.tpl',
            'tplFilter.row.shield-color' => '@FILE chunks/tpl.filter.row.msoption.msColor.tpl',
            'tplFilter.outer.trademark' => '@FILE chunks/tpl.filter.outer.msvendor.name.tpl',
            'tplFilter.row.trademark' => '@FILE chunks/tpl.filter.row.msvendor.name.tpl',
            'tplFilter.outer.metal-thickness' => '@FILE chunks/tpl.filter.outer.msoption.cover.tpl',
            'tplFilter.row.metal-thickness' => '@FILE chunks/tpl.filter.row.msoption.cover.tpl',
            'tplFilter.outer.width' => '@FILE chunks/tpl.filter.outer.msoption.width.tpl',
            'tplFilter.row.width' => '@FILE chunks/tpl.filter.row.msoption.width.tpl',
            'tplFilter.outer.side' => '@FILE chunks/tpl.filter.outer.msoption.width.tpl',
            'tplFilter.row.side' => '@FILE chunks/tpl.filter.row.msoption.width.tpl',
            'tplPageWrapper' => '@INLINE <ul class="pagination text-center">{$first}{$prev}{$pages}{$next}{$last}</ul></nav>',
            'tplPage' => '@INLINE <li class="page-item"><a class="page-link waves-effect waves-effect" href="{$href}">{$pageNo}</a></li>',
            'tplPageActive' => '@INLINE <li class="page-item active"><a class="page-link waves-effect waves-effect" href="{$href}">{$pageNo}</a></li>',
            'tplPagePrev' => '@INLINE <li class="page-item"><a class="page-link waves-effect waves-effect" aria-label="Previous" href="{$href}"><span aria-hidden="true">←</span><span class="sr-only">Предыдущая</span></a></li>',
        ...
        {$_modx->RunSnippet('!mFilter2', [
            ...
            'tplFilter.outer.trademark' => '@FILE chunks/tpl.filter.outer.msvendor.name.tpl',
            'tplFilter.row.trademark' => '@FILE chunks/tpl.filter.row.msvendor.name.tpl',
            'tplFilter.outer.coating' => '@FILE chunks/tpl.filter.outer.msoption.cover.tpl',
            'tplFilter.row.coating' => '@FILE chunks/tpl.filter.row.msoption.cover.tpl',
            'tplFilter.outer.width' => '@FILE chunks/tpl.filter.outer.msoption.width.tpl',
            'tplFilter.row.width' => '@FILE chunks/tpl.filter.row.msoption.width.tpl',
            'tplFilter.outer.type' => '@FILE chunks/tpl.filter.outer.msoption.doorType.tpl',
            'tplFilter.row.type' => '@FILE chunks/tpl.filter.row.msoption.doorType.tpl',
            'tplFilter.outer.glass-color' => '@FILE chunks/tpl.filter.outer.msoption.glass.tpl',
            'tplFilter.row.glass-color' => '@FILE chunks/tpl.filter.row.msoption.glass.tpl',
            'tplPageWrapper' => '@INLINE <ul class="pagination text-center">{$first}{$prev}{$pages}{$next}{$last}</ul></nav>',
            'tplPage' => '@INLINE <li class="page-item"><a class="page-link waves-effect waves-effect" href="{$href}">{$pageNo}</a></li>',
            'tplPageActive' => '@INLINE <li class="page-item active"><a class="page-link waves-effect waves-effect" href="{$href}">{$pageNo}</a></li>',
            'tplPagePrev' => '@INLINE <li class="page-item"><a class="page-link waves-effect waves-effect" aria-label="Previous" href="{$href}"><span aria-hidden="true">←</span><span class="sr-only">Предыдущая</span></a></li>',
        ...
        {$_modx->RunSnippet('!mFilter2', [
            ...
            'tplFilter.row.color' => '@FILE chunks/tpl.filter.row.msoption.msColor.tpl',
            'tplFilter.outer.trademark' => '@FILE chunks/tpl.filter.outer.msvendor.name.tpl',
            'tplFilter.row.trademark' => '@FILE chunks/tpl.filter.row.furniture_msvendor.name.tpl',
            'tplFilter.outer.type' => '@FILE chunks/tpl.filter.outer.msoption.cover.tpl',
            'tplFilter.row.type' => '@FILE chunks/tpl.filter.row.msoption.furniture_type.tpl',
            'tplPageWrapper' => '@INLINE <ul class="pagination text-center">{$first}{$prev}{$pages}{$next}{$last}</ul></nav>',
            'tplPage' => '@INLINE <li class="page-item"><a class="page-link waves-effect waves-effect" href="{$href}">{$pageNo}</a></li>',
            'tplPageActive' => '@INLINE <li class="page-item active"><a class="page-link waves-effect waves-effect" href="{$href}">{$pageNo}</a></li>',
