...
<html>
	<head>
		...
		<!--<![endif]-->
		<!--[if lte IE 8]>
		<script type="text/javascript" src="/assets/virtual-tour/lib/jquery-1.10.2.min.js"></script>
		<![endif]-->
		<!--[if gt IE 8]>
		<script type="text/javascript" src="/assets/virtual-tour/lib/jquery-2.0.3.min.js"></script>
		<![endif]-->
				...
				<div id="panoDIV">
					<noscript>
						...
						<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" width="100%" height="100%" id="/assets/virtual-tour/02.04">
							...
							<!--[if !IE]>-->
							<object type="application/x-shockwave-flash" data="/assets/virtual-tour/02.04.swf" width="100%" height="100%">
								<param name="movie" value="/assets/virtual-tour/02.04.swf"/>
								<param name="allowFullScreen" value="true"/>
								<!--<![endif]-->
