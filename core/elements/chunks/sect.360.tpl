        ...
        <div class="row row--marketing"  style="background-image: url('/assets/i/bg-romb.png')">
            <div class="container container--narrow">
                <div class="row pt-5 pb-3 text-center">
                    ...
                    <div class="col-md-6 text-md-right"><h4 class="card-title mb-0"><strong>Современный</strong> способ <strong>купить<br>двери в Новосибирске, Новокузнецке и Кемерово</strong></h4></div>
                </div>
            </div>
        </div>
    </div>
