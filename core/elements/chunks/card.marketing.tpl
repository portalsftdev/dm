<div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel" data-interval="3000">
    ...
    <div class="carousel-inner" role="listbox">
        ...
        'parents' => $_modx->config.id_marketing,
        ...
        'sortdir' => 'DESC',
        'tvPrefix' => '',
        'includeTVs' => 'marketing_label',
        'tpl' => "@FILE chunks/tpl.marketing.row.tpl",
        ])}
-->
        <div class="carousel-item active">
            <div class="card card-overlay card-overlay--marketing hover-effect-control mb-4" style="width: 100%; background-image: url('/assets/i/bg-rassroch-1.jpg')">
                <div class="card-block text-xs-center text-white">
                    <div class="tag tag-layer-orange mb-5"><h2 class="card-title m-0 py-1"><strong>0%</strong></h2></div>
                    <h4 class="card-title mb-0">Беспроцентная рассрочка</h4>
                    <h2 class="card-title">До <strong class="text-primary">4-х месяцев</strong></h2>
                </div>
            </div>
        </div>
