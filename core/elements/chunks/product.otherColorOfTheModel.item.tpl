<div class="d-inline-block" role="link" onclick="location.href = '[[~[[+productID]]]]';">
  <input class="color-checkbox" type="radio" name="[[+key]]" value="[[+optionValue:htmlentities]]" id="expo-color-[[+key]]-[[+id]]"[[+optionValue:is=`[[+currentOptionValue]]`:then=` checked`]]>
