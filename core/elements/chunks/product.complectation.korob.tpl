<tr>
    <td>
        <div class="lead">
            [[+productName]]
            <span class="question-mark-icon" data-toggle="tooltip" data-html="true" data-placement="right" title="<div style='padding:.75rem;text-align:left;text-indent:1rem;'><strong>Короб</strong>&nbsp;&mdash;&nbsp;рамочная П-образная конструкция, на которую навешивается дверное полотно. Это неподвижная часть дверного блока, которая прочно закрепляется в стенках дверного проема.<div>"></span>
        </div>
    </td>
    <td>
